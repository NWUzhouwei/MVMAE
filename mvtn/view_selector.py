...
from .model.ops import  batched_index_select_parts
...
class MVTN(nn.Module):
    ...
    def __init__(self, nb_views=12, views_config="circular", canonical_elevation=30.0, canonical_distance=0.95, transform_distance=False, input_view_noise=0.0, shape_extractor="pointnet", shape_features_size=512, screatch_feature_extractor=False):
        super().__init__()
