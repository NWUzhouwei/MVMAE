...
import torch
from mvtn.ops import check_and_correct_rotation_matrix
...
class MVRenderer(nn.Module):
    ...
    def __init__(self, nb_views, image_size=112, pc_rendering=True, object_color="white", background_color="white", faces_per_pixel=2, points_radius=0.006,  points_per_pixel=1, light_direction="random", cull_backfaces=False):
        super().__init__()
