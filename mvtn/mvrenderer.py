...
class MVRenderer(nn.Module):
    ...
    def __init__(self, nb_views, image_size=40, pc_rendering=False, object_color="black", background_color="white", faces_per_pixel=1, points_radius=0.006,  points_per_pixel=1, light_direction="random", cull_backfaces=False, return_mapping=True):
        super().__init__()
